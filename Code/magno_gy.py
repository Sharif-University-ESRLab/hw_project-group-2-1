...
if __name__ == "__main__":
	...
	print ("   Xangle = %.3f" % ( gyro.getX() ))
	print ("   Yangle = %.3f" % ( gyro.getY() ))
	print ("   Zangle = %.3f" % ( gyro.getZ() ))
	
	print ("   Xangle = %.3f raw" % ( gyro.getRawX() ))
	print ("   Yangle = %.3f raw" % ( gyro.getRawY() ))
	print ("   Zangle = %.3f raw" % ( gyro.getRawZ() ))
